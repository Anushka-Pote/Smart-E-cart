...
const productInfo = {
    ...
    'Parle-G': { expiryDate: '2026-Oct-05', type: 'Veg', allergies: ['Contains Milk, Wheat, and is made in a facility that process peanuts, tree nuts, soy, dairy, and wheat ingredients.'] },
};
...
function setupCamera() {
    ...
    document.addEventListener('keydown', (event) => {
        if (event.key === 'Enter') {
            ...
            const product = { name: detectedProduct, price: 5.00 }; 
